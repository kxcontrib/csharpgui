...
namespace kx
{
    public class c : TcpClient
    {
        ...
        public c(string h, int p)
            : this(h, p, Environment.UserName, "")
        {
        }

        public c(string h, int p, string u, string pw)
            : this(h, p, u, pw, DefaultMaxBufferSize)
        {
        }
        ...
        public c(string h, int p, string u, string pw, int maxBufferSize)
        {
            ...
            J = 0;
            w(u + ":" + pw + "\x3");
            s.Write(B, 0, J);//THIS LINE SENDS JUNK TO .Z.PW;
 ...
 new Month(ni),new Date(ni),new DateTime(0),new KTimespan(nj),new Minute(ni),new Second(ni),new TimeSpan(nj)};
        ...
        public static Flip td(object X)
        {
            ...
            object[] y = new object[m + n]; Array.Copy(a.y, 0, y, 0, m); Array.Copy(b.y, 0, y, m, n); 
        ...
        public object k() //This is what runs the query
        { 
            read(b = new byte[8]); 
            a = b[0] == 1;
            bool c = b[2] == 1;
